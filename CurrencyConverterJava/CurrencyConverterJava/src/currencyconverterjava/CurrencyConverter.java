...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "LKR" }));
        txtFrom.setToolTipText("");

        txtTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "LKR", "USD" }));
    ...
    private void ConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConvertActionPerformed
        ...
        if(txtFrom.getSelectedItem().toString()=="USD" && txtTo.getSelectedItem().toString()=="LKR"){
            convert = amount * 52;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" LKR");
        }
        else if(txtFrom.getSelectedItem().toString()=="LKR" && txtTo.getSelectedItem().toString()=="USD"){
            convert = amount * 0.0027;
